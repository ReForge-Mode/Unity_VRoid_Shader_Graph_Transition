...
public class SwapTextureShader : MonoBehaviour
{
    ...
    public void swapTexture()
    {
        ...
        if (textureIndex == 1)
        {
            ...
            {
                item_swap.mat.SetTexture("_MainTex2", item_swap.texture2);
                item_swap.mat.SetTexture("_ShadeTexture2", item_swap.texture2);
            }
        ...
        else if (textureIndex == 2)
        {
            foreach (var item_swap in swappableList)
            {
                item_swap.mat.SetTexture("_MainTex2", item_swap.texture1);
                item_swap.mat.SetTexture("_ShadeTexture2", item_swap.texture1);
            }
